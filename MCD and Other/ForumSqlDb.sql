...
INSERT INTO `topic` (`id_topic`, `title`, `creationdate`, `closed`, `jaime`, `categorie_id`, `user_id`, `description`) VALUES
...
INSERT INTO `user` (`id_user`, `pseudo`, `mot_de_passe`, `DateInscription`, `role`, `email`) VALUES
	(1, 'admin', 'admin', '2023-08-30 08:43:15', 'admin', 'admin@admin.com'),
	(2, 'User1', '123', '2023-08-30 08:45:24', 'verifier', 'user1@gmail.com');
