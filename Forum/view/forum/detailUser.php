...
<div class="container-DetailUser">
    <div class="container-InfoUser">
        ...
        if(App\Session::getUser()){
            ...
            <?php if(App\Session::isAdmin() || App\Session::getUser()->getId() == $user->getId()){?>
                    <a href="index.php?ctrl=forum&action=deleteUser&id=<?= $user->getId(); ?>">
                        <figure class="figure-img-listCategorie" style="background-color: #e4717a;">
                            <img src="./public/img/delete.png" alt="delete">
                        </figure>
                    </a>
                    <a href="index.php?ctrl=forum&action=editUser&id=<?= $user->getId(); ?>">
