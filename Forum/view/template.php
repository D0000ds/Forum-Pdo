            ...
            <nav class="nav">
                ...
                if(App\Session::getUser()){?>
                    <div class="inscription_connexion">
                        <a class="hoverNav" href="index.php?ctrl=forum&action=userPage"><?php  echo App\Session::getUser()->getPseudo(); ?></a>
                        <figure class="profile-picture">
                            <img src="<?php  echo App\Session::getUser()->getPicture(); ?>" alt="<?php echo App\Session::getUser()->getPseudo(); ?>">
                        </figure>
                    </div>
          <?php } else { ?>
                    <div class="inscription_connexion">
